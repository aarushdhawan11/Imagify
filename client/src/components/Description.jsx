...
const Description = () => {
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className='flex flex-col items-center justify-center my-24 p-6 md:px-28 dark:bg-gray-900 dark:text-gray-100'>
        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
          ...
          <div>
            <h2 className='text-3xl font-medium max-w-lg mb-4 text-gray-900 dark:text-white'>
